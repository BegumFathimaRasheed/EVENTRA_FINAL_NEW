...
<html>
<head>
    <title>Conference Package</title>
    <!--Google Font-->
...
<body>
    ...
    <div class="menu">
        <div class="heading">
            <h1>EVENTRA</h1>
            <h3>&mdash; CONFERENCE CATEGORY &mdash; </h3>
        </div>
        <div class="event-items">
            <img src="https://images.unsplash.com/photo-1511578314322-379afb476865?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fGJ1c2luZXNzJTIwY29uZmVyZW5jZXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60">
            <div class="details">
                ...
                <p>Venue selection and setup<br>
                    ...
                    Speaker and agenda management<br>
                    Catering and refreshments<br>
                    Sponsorship and exhibitor management<br>
                    Guest speakers<br>
                    Audiovisual and staging<br>
                    Networking opportunities<br>
                    Event technology and mobile apps<br>
                    On-site staff and volunteersg<br>
                    Post-conference follow-up<br><br>
                    
                    <b>Price LKR.1,000,000.00 </b></p>
                <button onclick="redirectToCategoryAndPackage('ELITE', 'CONFERENCE')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://images.unsplash.com/photo-1558008258-3256797b43f3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGJ1c2luZXNzJTIwY29uZmVyZW5jZXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60">
            <div class="details">
                <div class="details-sub">
                ...
                <p>Venue selection and setup<br>
                    ...
                    Networking opportunities<br>
                    Event technology and mobile apps<br>
                    On-site staff and volunteersg<br><br>
                    <b>Price LKR.950,000.00</b></p>
                    <button onclick="redirectToCategoryAndPackage('GOLD', 'CONFERENCE')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTF8fGV2ZW50fGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60">
            <div class="details">
                <div class="details-sub">
                ...
                <p>Venue selection and setup<br>
                    ...
                    Audiovisual and staging<br>
                    Networking opportunities<br>
                    Event technology and mobile apps<br><br>
                   <b> Price LKR.850,000.00</b></p>
                    <button onclick="redirectToCategoryAndPackage('PREMIER', 'CONFERENCE')">Purchase</button>
            </div>
        </div>
