...
<html>
<head>
    <title>Get-Together Package</title>
    <!--Google Font-->
...
<body>
    ...
    <div class="menu">
        <div class="heading">
            <h1>EVENTRA</h1>
            <h3>&mdash; GET-TOGETHER CATEGORY &mdash; </h3>
        </div>
        <div class="event-items">
            <img src="https://images.unsplash.com/photo-1621112904887-419379ce6824?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDN8fHxlbnwwfHx8fHw%3D&auto=format&fit=crop&w=500&q=60">
            <div class="details">
                ...
                <p>Venue selection and setup<br>
                    ...
                    Appetizers and Meal Services<br>
                    Bar Services<br>
                    Live bands or solo musicians<br>
                    DJs<br>
                    Dance performances<br>
                    Guest speakers<br>
                    Audiovisual and staging<br>
                    Photography and videography<br>
                    Memorabilia and keepsakes<br>
                    Post-event follow-up<br><br>
                    <b>Price LKR.100,000.00 </b></p>
                <button onclick="redirectToCategoryAndPackage('ELITE', 'GET_TOGETHER')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://images.pexels.com/photos/5778899/pexels-photo-5778899.jpeg?auto=compress&cs=tinysrgb&w=600">
            <div class="details">
                <div class="details-sub">
                ...
                <p>Venue selection and setup<br>
                    ...
                    Photography and videography<br>
                    Post-event follow-up<br><br>
                    <b>Price LKR.90,000.00</b></p>
                    <button onclick="redirectToCategoryAndPackage('GOLD', 'GET_TOGETHER')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://images.pexels.com/photos/7148972/pexels-photo-7148972.jpeg?auto=compress&cs=tinysrgb&w=600">
            <div class="details">
                <div class="details-sub">
                ...
                <p>Venue selection and setup<br>
                    ...
                    Photography and videography<br>
                    Post-event follow-up<br><br>
                    <b>Price LKR.80,000.00</b></p>
                    <button onclick="redirectToCategoryAndPackage('PREMIER', 'GET_TOGETHER')">Purchase</button>
            </div>
        </div>
    </div>
