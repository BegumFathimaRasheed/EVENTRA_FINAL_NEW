...
<html>
<head>
    <title>Private Party Package</title>
    <!--Google Font-->
...
<body>
    ...
    <div class="menu">
        <div class="heading">
            <h1>EVENTRA</h1>
            <h3>&mdash; PRIVATE PARTY &mdash; </h3>
        </div>
        <div class="event-items">
            <img src="https://www.johntogo.com/wp-content/uploads/2022/06/wedding-anniversary-party-decor.jpg" style="height: 295px;">
            <div class="details">
                <div class="details-sub">
                    <h5 style="padding-left: 100px;">ANNIVERSARY PARTY</h5>
                </div>
                <p>Venue selection and setup<br>Theme development and decor<br>Anniversary cake and desserts<br>Appetizers and Meal Services<br>Bar Services<br>Live bands or solo musicians<br>DJs<br>Dance performances<br>Audiovisual and staging<br>Photography and videography<br>Special surprises or activities<br>Customized favors and gifts<br><br><br><span style="font-weight: bolder; font-size: large;">Price LKR.90,000.00</span></p>
                <button onclick="redirectToCategoryAndPackage('ANNIVERSARY', 'PRIVATE')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://www.aucklandweddings.co.nz/laravel-filemanager/images/filemanager/Misc.%20folder/etsy.jpg" style="height: 295px;">
            <div class="details">
                <div class="details-sub">
                    <h5 style="padding-left: 125px;">ENGAMENT PARTY</h5>
                </div>
                <p>Venue selection and setup<br>Theme development and decor<br>Appetizers and Meal Services<br>Bar Services<br>DJs<br>Dance performances<br>Audiovisual and staging<br>Photography and videography<br>Guest speakers<br>Event branding and marketing<br><br><br><br><br><span style="font-weight: bolder; font-size: large;">Price LKR.80,000.00</span></p>
                    <button onclick="redirectToCategoryAndPackage('ENGAMENT', 'PRIVATE')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://livingwellplanningwell.com/wp-content/uploads/2023/02/graduation-party-ideas-47.png" style="height: 295px;">
            <div class="details">
                <div class="details-sub">
                    <h5 style="padding-left: 125px;">GRADUATION PARTY</h5>
                </div>
                <p>Venue selection and setup<br>Theme development and decor<br>Appetizers and Meal Services<br>Bar Services<br>DJs<br>Audiovisual and staging<br>Photography and videography<br>Guest speakers<br>Awards or recognition ceremony<br><br><br><br><br><br><span style="font-weight: bolder; font-size: large;">Price LKR.60,000.00</span></p>
                    <button onclick="redirectToCategoryAndPackage('GRADUATION', 'PRIVATE')">Purchase</button>
            </div>
        </div>
        <div class="event-items">
            <img src="https://www.quicklets.com.mt/web/uploads/blog/original/blog-image-232.jpg" style="height: 295px;">
            <div class="details">
                <div class="details-sub">
                    <h5 style="padding-left: 120px;">DINNER PARTY</h5>
                </div>
                <p>Venue selection and setup<br>Theme development and decor<br>Appetizers and Meal Services<br>Bar Services<br>Audiovisual and staging<br>Photography and videography<br>Live bands or solo musicians<br>Table design and setup<br><br><br><br><br><span style="font-weight: bolder; font-size: large;">Price LKR.50,000.00</span></p>
                <button onclick="redirectToCategoryAndPackage('DINNER', 'PRIVATE')">Purchase</button>
            </div>
        </div>

        <div class="event-items">
            <img src="https://homeownersfg.com/wp-content/uploads/AdobeStock_558713133-scaled.jpeg" style="height: 295px;">
            <div class="details">
                <div class="details-sub">
                    <h5 style="padding-left: 105px;">HOUSEWARMING PARTY</h5>
                </div>
                <p>House decoration<br>Theme development and decor<br>Appetizers and Meal Services<br>Bar Services<br>Background music<br><br><br><br><br><br><br><br><span style="font-weight: bolder; font-size: large;">Price LKR.20,000.00</span></p>
                    <button onclick="redirectToCategoryAndPackage('HOUSEWARMING', 'PRIVATE')">Purchase</button>
            </div>
        </div>
    </div>
    ...
    <script>
                        const categoryRedirectMap = {
                            'ANNIVERSARY': 'parchase.jsp',
                            'ENGAMENT': 'parchase.jsp',
                            'GRADUATION': 'parchase.jsp',
                            'DINNER': 'parchase.jsp',
                            'HOUSEWARMING': 'parchase.jsp'
                        };
